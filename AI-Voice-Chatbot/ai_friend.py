...
from utils import elimina_file_cartella
...
template = """You are a chatbot that not friendly and arrogant.
Feel free to ask interesting questions that keeps someone engages.
...
def conversation():
    ...
    while True:
        ...
        if user_input is None:
            ...
            respond(conversation_chain.run({
...
if __name__ == "__main__":
    cartella_speech = 'speech'
    cartella_user_speech = 'user_speech'

    # Esegui la funzione per entrambe le cartelle
    elimina_file_cartella(cartella_speech)
    elimina_file_cartella(cartella_user_speech)
